...
# Приветствую. Я — Виталий Новиков, специалист и руководитель в области информационной безопасности.  
## Руководитель службы кибербезопасности · Архитектура ИБ · SOC / IR · DevSecOps
...
- соответствие рекомендациям CIS Benchmark и ФСТЭК.
